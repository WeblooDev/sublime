...
import { FourItemsBlock } from '@/blocks/FourItems/config'
import { FaqSectionBlock } from '@/blocks/FaqSection/config'
import { TestimonialsBlock } from '@/blocks/TestimonialsSection/config'
import { SubscribeSectionBlock } from '@/blocks/SubscribeSection/config'
import { CategoriesCatalogBlock } from '@/blocks/CategoriesCatalog/config'
